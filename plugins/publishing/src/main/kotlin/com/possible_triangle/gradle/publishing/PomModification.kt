...
@Deprecated("dependency filters now also filter the module metadata", replaceWith = ReplaceWith("removeRuntimeDependencies()"))
fun MavenPublication.removeRuntimePomDependencies() {
    removePomDependencies(DependencyFilter(scope = "runtime"))
}

@Deprecated("dependency filters now also filter the module metadata", replaceWith = ReplaceWith("removeDependencies()"))
...
@Deprecated("dependency filters now also filter the module metadata", replaceWith = ReplaceWith("removeDependencies(filter)"))
