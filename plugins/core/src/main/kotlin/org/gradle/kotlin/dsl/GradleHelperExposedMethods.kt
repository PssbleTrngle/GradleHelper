...
fun Project.enableSpotless(block: SpotlessExtension.() -> Unit = {}) = configureSpotless(block)

fun DependencyHandlerScope.modApi(
    dependencyNotation: Any,
    block: ModuleDependency.() -> Unit = {},
) = addModDependency("api", dependencyNotation, block)

fun DependencyHandlerScope.modImplementation(
    dependencyNotation: Any,
    block: ModuleDependency.() -> Unit = {},
) = addModDependency("implementation", dependencyNotation, block)

fun DependencyHandlerScope.modRuntimeOnly(
    dependencyNotation: Any,
    block: ModuleDependency.() -> Unit = {},
) = addModDependency("runtimeOnly", dependencyNotation, block)

fun DependencyHandlerScope.modCompileOnly(
    dependencyNotation: Any,
    block: ModuleDependency.() -> Unit = {},
) = addModDependency("compileOnly", dependencyNotation, block)

fun DependencyHandlerScope.modCompileOnlyApi(
    dependencyNotation: Any,
    block: ModuleDependency.() -> Unit = {},
